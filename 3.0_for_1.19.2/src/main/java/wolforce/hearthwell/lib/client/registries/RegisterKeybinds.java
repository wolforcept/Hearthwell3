...
public class RegisterKeybinds {
    ...
    private static final HashMap<String, RegisterKeybinds.RegisterKeybindPoint> KEYBINDS = new HashMap<>();

    public static Collection<RegisterKeybinds.RegisterKeybindPoint> getAll() {
        return KEYBINDS.values();
    }

    public static RegisterKeybindPoint keybind(String regName, int key) {
        return new RegisterKeybinds.RegisterKeybindPoint(regName, key);
    }
